        ...
        return (
                <div className="flex flex-col w-full max-w-md py-24 mx-auto stretch">
                        ...
                        >
                                ...
                                { isLoading
                                        ? <button onClick={ stop } className="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">Stop</button>
                                        : <button 
                                                type="submit" 
